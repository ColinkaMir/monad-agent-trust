...
@genType
and entities = {
    @as("Agent") agent: entityStoreOperations<Entities.Agent.t>,
    @as("AgentRater") agentRater: entityStoreOperations<Entities.AgentRater.t>,
    @as("Feedback") feedback: entityStoreOperations<Entities.Feedback.t>,
    @as("Rater") rater: entityStoreOperations<Entities.Rater.t>,
  }
  ...
  let entities = {
      agent: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Agent)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Agent.t,
            >
      ...
      agentRater: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.AgentRater)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.AgentRater.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      feedback: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Feedback)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Feedback.t,
            >
      ...
      rater: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Rater)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Rater.t,
            >
