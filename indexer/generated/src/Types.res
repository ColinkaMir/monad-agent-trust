...
type contractRegistrations = {
  ...
  addIdentityRegistry: (Address.t) => unit,
  addReputationRegistry: (Address.t) => unit,
}
...
type loaderContext = {
  ...
  @as("Agent") agent: entityLoaderContext<Entities.Agent.t, Entities.Agent.indexedFieldOperations>,
  @as("AgentRater") agentRater: entityLoaderContext<Entities.AgentRater.t, Entities.AgentRater.indexedFieldOperations>,
  @as("Feedback") feedback: entityLoaderContext<Entities.Feedback.t, Entities.Feedback.indexedFieldOperations>,
  @as("Rater") rater: entityLoaderContext<Entities.Rater.t, Entities.Rater.indexedFieldOperations>,
}
...
type handlerContext = {
  ...
  effect: 'input 'output. (Envio.effect<'input, 'output>, 'input) => promise<'output>,
  chains: Internal.chains,
  @as("Agent") agent: entityHandlerContext<Entities.Agent.t>,
  @as("AgentRater") agentRater: entityHandlerContext<Entities.AgentRater.t>,
  @as("Feedback") feedback: entityHandlerContext<Entities.Feedback.t>,
  @as("Rater") rater: entityHandlerContext<Entities.Rater.t>,
}

//Re-exporting types for backwards compatability
@genType.as("Agent")
type agent = Entities.Agent.t
@genType.as("AgentRater")
type agentRater = Entities.AgentRater.t
@genType.as("Feedback")
type feedback = Entities.Feedback.t
@genType.as("Rater")
type rater = Entities.Rater.t
...
let abi = Ethers.makeAbi((%raw(`[{"type":"event","name":"Registered","inputs":[{"name":"agentId","type":"uint256","indexed":true},{"name":"agentURI","type":"string","indexed":false},{"name":"owner","type":"address","indexed":true}],"anonymous":false}]`): Js.Json.t))
let eventSignatures = ["Registered(uint256 indexed agentId, string agentURI, address indexed owner)"]
@genType type chainId = [#143]
let contractName = "IdentityRegistry"

module Registered = {

let id = "0xca52e62c367d81bb2e328eb795f7c7ba24afb478408a26c0e201d155c449bc4a_3"
let sighash = "0xca52e62c367d81bb2e328eb795f7c7ba24afb478408a26c0e201d155c449bc4a"
let name = "Registered"
let contractName = contractName

@genType
type eventArgs = {agentId: bigint, agentURI: string, owner: Address.t}
@genType
type block = Block.t
@genType
...
let paramsRawEventSchema = S.object((s): eventArgs => {agentId: s.field("agentId", BigInt.schema), agentURI: s.field("agentURI", S.string), owner: s.field("owner", Address.schema)})
...
@genType
type eventFilter = {@as("agentId") agentId?: SingleOrMultiple.t<bigint>, @as("owner") owner?: SingleOrMultiple.t<Address.t>}
...
let register = (): Internal.evmEventConfig => {
  let {getEventFiltersOrThrow, filterByAddresses} = LogSelection.parseEventFiltersOrThrow(~eventFilters=handlerRegister->EventRegister.getEventFilters, ~sighash, ~params=["agentId","owner",], ~topic1=(_eventFilter) => _eventFilter->Utils.Dict.dangerouslyGetNonOption("agentId")->Belt.Option.mapWithDefault([], topicFilters => topicFilters->Obj.magic->SingleOrMultiple.normalizeOrThrow->Belt.Array.map(TopicFilter.fromBigInt)), ~topic2=(_eventFilter) => _eventFilter->Utils.Dict.dangerouslyGetNonOption("owner")->Belt.Option.mapWithDefault([], topicFilters => topicFilters->Obj.magic->SingleOrMultiple.normalizeOrThrow->Belt.Array.map(TopicFilter.fromAddress)))
  {
    ...
    convertHyperSyncEventArgs: (decodedEvent: HyperSyncClient.Decoder.decodedEvent) => {agentId: decodedEvent.indexed->Js.Array2.unsafe_get(0)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, owner: decodedEvent.indexed->Js.Array2.unsafe_get(1)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, agentURI: decodedEvent.body->Js.Array2.unsafe_get(0)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, }->(Utils.magic: eventArgs => Internal.eventParams),
    id,
  name,
  contractName,
...
let eventSignatures = ["NewFeedback(uint256 indexed agentId, address indexed clientAddress, uint64 feedbackIndex, int128 value, uint8 valueDecimals, string indexed indexedTag1, string tag1, string tag2, string endpoint, string feedbackURI, bytes32 feedbackHash)"]
@genType type chainId = [#143]
let contractName = "ReputationRegistry"

module NewFeedback = {

let id = "0x6a4a61743519c9d648a14e6493f47dbe3ff1aa29e7785c96c8326a205e58febc_4"
let sighash = "0x6a4a61743519c9d648a14e6493f47dbe3ff1aa29e7785c96c8326a205e58febc"
let name = "NewFeedback"
let contractName = contractName

@genType
type eventArgs = {agentId: bigint, clientAddress: Address.t, feedbackIndex: bigint, value: bigint, valueDecimals: bigint, indexedTag1: string, tag1: string, tag2: string, endpoint: string, feedbackURI: string, feedbackHash: string}
@genType
type block = Block.t
@genType
type transaction = Transaction.t
...
let paramsRawEventSchema = S.object((s): eventArgs => {agentId: s.field("agentId", BigInt.schema), clientAddress: s.field("clientAddress", Address.schema), feedbackIndex: s.field("feedbackIndex", BigInt.schema), value: s.field("value", BigInt.schema), valueDecimals: s.field("valueDecimals", BigInt.schema), indexedTag1: s.field("indexedTag1", S.string), tag1: s.field("tag1", S.string), tag2: s.field("tag2", S.string), endpoint: s.field("endpoint", S.string), feedbackURI: s.field("feedbackURI", S.string), feedbackHash: s.field("feedbackHash", S.string)})
let blockSchema = Block.schema
let transactionSchema = Transaction.schema
...
@genType
type eventFilter = {@as("agentId") agentId?: SingleOrMultiple.t<bigint>, @as("clientAddress") clientAddress?: SingleOrMultiple.t<Address.t>, @as("indexedTag1") indexedTag1?: SingleOrMultiple.t<string>}
...
let register = (): Internal.evmEventConfig => {
  let {getEventFiltersOrThrow, filterByAddresses} = LogSelection.parseEventFiltersOrThrow(~eventFilters=handlerRegister->EventRegister.getEventFilters, ~sighash, ~params=["agentId","clientAddress","indexedTag1",], ~topic1=(_eventFilter) => _eventFilter->Utils.Dict.dangerouslyGetNonOption("agentId")->Belt.Option.mapWithDefault([], topicFilters => topicFilters->Obj.magic->SingleOrMultiple.normalizeOrThrow->Belt.Array.map(TopicFilter.fromBigInt)), ~topic2=(_eventFilter) => _eventFilter->Utils.Dict.dangerouslyGetNonOption("clientAddress")->Belt.Option.mapWithDefault([], topicFilters => topicFilters->Obj.magic->SingleOrMultiple.normalizeOrThrow->Belt.Array.map(TopicFilter.fromAddress)), ~topic3=(_eventFilter) => _eventFilter->Utils.Dict.dangerouslyGetNonOption("indexedTag1")->Belt.Option.mapWithDefault([], topicFilters => topicFilters->Obj.magic->SingleOrMultiple.normalizeOrThrow->Belt.Array.map((value) => TopicFilter.keccak256(value->TopicFilter.castToHexUnsafe))))
  {
    getEventFiltersOrThrow,
    filterByAddresses,
    dependsOnAddresses: !(handlerRegister->EventRegister.isWildcard) || filterByAddresses,
    blockSchema: blockSchema->(Utils.magic: S.t<block> => S.t<Internal.eventBlock>),
    transactionSchema: transactionSchema->(Utils.magic: S.t<transaction> => S.t<Internal.eventTransaction>),
    convertHyperSyncEventArgs: (decodedEvent: HyperSyncClient.Decoder.decodedEvent) => {agentId: decodedEvent.indexed->Js.Array2.unsafe_get(0)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, clientAddress: decodedEvent.indexed->Js.Array2.unsafe_get(1)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, indexedTag1: decodedEvent.indexed->Js.Array2.unsafe_get(2)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, feedbackIndex: decodedEvent.body->Js.Array2.unsafe_get(0)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, value: decodedEvent.body->Js.Array2.unsafe_get(1)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, valueDecimals: decodedEvent.body->Js.Array2.unsafe_get(2)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, tag1: decodedEvent.body->Js.Array2.unsafe_get(3)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, tag2: decodedEvent.body->Js.Array2.unsafe_get(4)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, endpoint: decodedEvent.body->Js.Array2.unsafe_get(5)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, feedbackURI: decodedEvent.body->Js.Array2.unsafe_get(6)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, feedbackHash: decodedEvent.body->Js.Array2.unsafe_get(7)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, }->(Utils.magic: eventArgs => Internal.eventParams),
    id,
  name,
  contractName,
  isWildcard: (handlerRegister->EventRegister.isWildcard),
